    ...
    <footer className="bg-black dark:bg-gray-900 text-white">
            <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">KRE Elite Sport™</a>. All Rights Reserved.</span>
